...
namespace stan_qLearning_5params_opponency_rBarStart_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_rBarStart.stan");
    reader.add_event(150, 150, "end", "C:/Users/cooper_PC/Desktop/githubRepositories/cooperAnalysis/matlabCode/operantMatching/learningModels/stan/stan_qLearning_5params_opponency_rBarStart.stan");
    return reader;
}

class stan_qLearning_5params_opponency_rBarStart_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> Tsesh;
    ...
    vector_d initQ;
public:
    stan_qLearning_5params_opponency_rBarStart_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "stan_qLearning_5params_opponency_rBarStart_model_namespace::stan_qLearning_5params_opponency_rBarStart_model";
    ...
    ~stan_qLearning_5params_opponency_rBarStart_model() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(beta,i,"beta",1), (Phi_approx((get_base1(mu_p,4,"mu_p",1) + (get_base1(sigma,4,"sigma",1) * get_base1(beta_pr,i,"beta_pr",1)))) * 20));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "stan_qLearning_5params_opponency_rBarStart_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            check_less_or_equal(function__,"mu_beta",mu_beta,20);
            current_statement_begin__ = 91;
    ...
    static std::string model_name() {
        return "stan_qLearning_5params_opponency_rBarStart_model";
    }
...
typedef stan_qLearning_5params_opponency_rBarStart_model_namespace::stan_qLearning_5params_opponency_rBarStart_model stan_model;
